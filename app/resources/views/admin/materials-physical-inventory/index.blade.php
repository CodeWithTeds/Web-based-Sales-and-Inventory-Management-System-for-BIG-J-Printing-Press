                                            ...
                                            <form action="{{ route('admin.materials-physical-inventory.update', $item) }}" method="POST" class="mt-6">
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                    <div>
                                                        ...
                                                        <input id="physical_count_{{ $item->id }}" name="physical_count" type="number" min="0" step="0.01" value="{{ old('physical_count', 0) }}" class="mt-2 block w-full rounded-md border-gray-300 text-base p-3">
                                                    </div>
