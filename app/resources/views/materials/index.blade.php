                ...
                <div class="p-4">
                    <form action="{{ route('materials.by-category') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div class="col-span-1">
                            ...
                            <input type="text" name="category" id="category" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 text-sm" placeholder="Filter by category">
                        </div>
