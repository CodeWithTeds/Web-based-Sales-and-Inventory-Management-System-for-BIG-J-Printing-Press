...
class PosController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->header('HX-Request')) {
            return response()->view('admin.partials.pos-cart', $this->posService->getIndexData($category, $search));
        }

        return view('admin.pos-blade', $this->posService->getIndexData($category, $search));
    }
    ...
    public function add(Request $request, int $product)
    {
        ...
        if ($request->header('HX-Request')) {
            return response()->view('admin.partials.pos-cart', $this->posService->getCartPartialData());
        }
    ...
    public function checkout(PosCheckoutRequest $request)
    {
        ...
        $receiptUrl = route('admin.pos.receipt', $result['order']);
        if ($request->header('HX-Request')) {
